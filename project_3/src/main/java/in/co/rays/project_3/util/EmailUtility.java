...
/**
 * EmailUtility provides the email services. It is the most important class as it contains all the predefined classes and houses them in the sendMail method.
 * @author Vineet Goyal
 *
 */
