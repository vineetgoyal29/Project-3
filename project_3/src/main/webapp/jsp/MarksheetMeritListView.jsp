...
<body class="p4">
	...
	<div>
		<form action="<%=ORSView.MARKSHEET_MERIT_LIST_CTL%>" method="post">
			...
			<div align="center">
				<h1 class="text-primary font-weight-bold pt-3">Marksheet Merit List</h1>
			</div>
			...
			<div style="margin-bottom: 20px;" class="table-responsive">
				...
				<table class="table table-dark">
					<table class="table table-hover" style ="background-image: url('<%=ORSView.APP_CONTEXT%>/img/marksheetMeritListFinal.png');">
						<thead>
