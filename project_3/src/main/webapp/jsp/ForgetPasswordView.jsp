			...
			<div class="row pt-5">
				...
				<div class="col-md-4">
					<div class="card input-group-addon">
						<div class="card-body">
							<h3 class="text-center default-text text-primary">Forgot Your Password?</h3>
							<p class="text-center default-text text-info" style="font-size:11px;"> Submit your Email Address and we will send your password via E-mail</p>
